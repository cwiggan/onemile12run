...
const ThankYou = (props) => (
    <div className="card-body">
        ...
        <p className="card-text">
            Congratulations {props.data.name} on taking the first step toward participating in the 2019 1 Mile with a Smile 12 hour run. This exciting event kicks off Saturday, August 10 at the Oak Gove Lake Park with the 12 Hour Endurance!
        </p>
        <p className="card-text">
        ...
        <p className="card-text">
                <strong>Packet Pick up</strong><br/> No Packet Pick Up For 12 Hour Race Participant Race Day Check-in AT 6:00AM
        </p>
        <p className="card-text">
